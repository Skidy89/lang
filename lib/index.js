...
exports.SSL = void 0;
const lang_helper_1 = require("lang-helper");
/** SSL.js */
class SSL {
    constructor(dir) {
        this._loader = null;
    ...
    async load() {
        if (!this._loader)
            this._loader = lang_helper_1.loadChdlang;
        return await this._loader(this._dir);
    }
    async generateTypescriptDefs(output) {
        return (0, lang_helper_1.generateTypescriptDefs)(this._dir, output);
    }
    /** Clears the global language cache */
    clearCache() {
        (0, lang_helper_1.clearLangCache)();
    }
